...
######################################        
#               train model     with 1 gru
#####################################    
def train1gru(img_w,img_h,path_data,load,path_name_model,epoch_cnt):
    # Input Parameters
...
def train2gru(img_w,img_h,path_data,load,path_name_model,epoch_cnt):
    # Input Parameters
    ...
    return model
####################################
def train3gru(img_w,img_h,path_data,load,path_name_model,epoch_cnt):
    # Input Parameters
    ...
    #**********    
    inner = Dense(tiger_train.get_output_size(), kernel_initializer='he_normal',
                  name='dense2')(concatenate([gru_3, gru_3b]))  
